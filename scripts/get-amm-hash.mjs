#!/usr/bin/env node
/**
 * Get AMM Contract Hash from deployer account
 */
...
async function main() {
  console.log("Fetching AMM contract hash...");
  ...
  // Find the AMM contract hash
  const ammHashKey = namedKeys.find(k => k.name === "bonding_curve_amm_hash");

  if (ammHashKey) {
    console.log("========================================");
    console.log("AMM Contract Found!");
    console.log("========================================");
    console.log("Contract Hash:", ammHashKey.key);
    console.log("");
    console.log("Add this to your .env file:");
    console.log(`AMM_CONTRACT_HASH="${ammHashKey.key}"`);
    console.log("");
  } else {
    console.log("AMM contract hash not found yet.");
