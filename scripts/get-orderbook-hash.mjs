#!/usr/bin/env node
/**
 * Get Order Book Contract Hash from deployer account
 */
...
async function main() {
  console.log("Fetching Order Book contract hash...");
  ...
  const orderbookHashKey = namedKeys.find(k => k.name === "orderbook_hash");

  if (orderbookHashKey) {
    console.log("========================================");
    console.log("Order Book Contract Found!");
    console.log("========================================");
    console.log("Contract Hash:", orderbookHashKey.key);
    console.log("");
    console.log("Add this to your .env file:");
    console.log(`ORDERBOOK_CONTRACT_HASH="${orderbookHashKey.key}"`);
    console.log("");
  } else {
    console.log("Order Book contract hash not found yet.");
